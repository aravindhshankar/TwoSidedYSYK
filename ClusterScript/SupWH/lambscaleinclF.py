...
if not os.path.exists('../Dump/'):
	...
	path_to_loadfile = '../Dump/v2LOWTEMP_lamb_anneal_dumpfiles/'
...
for lamb in lamblooplist:
    ...
    loadfile += 'lamb' + f'{lamb:.3}' + 'J' + str(J)
