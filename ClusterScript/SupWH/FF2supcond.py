...
for beta in betalooplist:
    ...
    # try:
    #     # GDtau,DDtau,FDtau,GODtau,DODtau,FODtau = np.load(os.path.join(path_to_dump, loadfile)) 
    #     GDtau,GODtau,DDtau,DODtau = np.load(os.path.join(path_to_loadfile, loadfile)) 
    # except FileNotFoundError:
    #     print(loadfile, " not found")
    #     exit(1)
