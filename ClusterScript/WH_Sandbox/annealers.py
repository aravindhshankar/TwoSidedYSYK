...
def anneal_temp(target_beta,GFtaus,Nbig,beta_start,g,r,mu,lamb,J,kappa,DUMP=False,path_to_dump=None,calcfe=False,verbose=True):
	if verbose: 
...
def anneal_lamb(target_lamb,GFtaus,Nbig,beta_start,g,r,mu,lamb,J,kappa,DUMP=False,path_to_dump=None,calcfe=False,verbose=True):
	return None
...
def test_anneal_temp():
	...
	GDtau,GODtau,DDtau,DODtau,fe_list = anneal_temp(target_beta,GFtaus,Nbig,beta_start,g,r,mu,lamb,J,kappa,
