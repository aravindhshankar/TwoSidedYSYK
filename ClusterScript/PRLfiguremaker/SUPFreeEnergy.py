...
data["axlim"] = {"xlim":[1./108,0.21], "ylim":[-1.22,-0.8]}
# ax.set_xlim(1./108,0.21)
# ax.set_ylim(-1.22,-0.8)
with open('SUP_FEmain_panel.json', 'w') as f:
...
data2["axlim"] = {"xlim":[1./108,0.21], "ylim":[-1.49,0]}
# ax2.set_xlim(1./108,0.21)
# ax2.set_ylim(-1.49,0)
with open('PartialTFsupMAIN.json', 'w') as f:
    json.dump(data2, f, indent=4)

print("axis ax2inset")
data2i = {}
for line in ax2inset.lines:
    label = line.get_label()
    try:
        xdata = line.get_xdata().tolist()
    except:
    ...
    try:
        ...
        ydata = line.get_xdata()
    data2i[label] = {"x" : xdata, "y": ydata}
data2i["axlim"] = {"xlim":[1./75,1./55], "ylim":[-0.1,0]}
# ax2inset.set_xlim(1./75,1./55)
# ax2inset.set_ylim(-0.1,0)

with open('PartialTFsupINSET.json', 'w') as f:
    json.dump(data2i, f, indent=4)
